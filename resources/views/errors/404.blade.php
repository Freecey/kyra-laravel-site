...
<head>
    ...
    <title>404 — Signal perdu · Kyra</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .code {
            ...
            font-weight: 900;
            color: var(--cyan);
            text-shadow: 0 0 40px rgba(0,200,255,.4), 0 0 80px rgba(0,200,255,.15);
            letter-spacing: .05em;
            line-height: 1;
        }
        .kicker {
...
<body>
    ...
    <div class="wrap">
        ...
        <div class="kicker">// erreur système</div>
        <div class="title">Signal perdu</div>
        <div class="terminal">
            <div><span class="prompt">$</span> resolve <span class="val">{{ request()->path() }}</span></div>
            <div><span class="err">ERR</span> route non résolue</div>
            <div><span class="prompt">$</span> status <span class="err">NOT_FOUND</span></div>
            <div><span class="prompt">$</span> uptime <span class="val">ONLINE</span> · v2026.4</div>
        </div>
